...
### Search Panel
![Search Panel](https://via.placeholder.com/800x400.png?text=Search+Panel+with+Multiple+Queries)

### Results View
![Results](https://via.placeholder.com/800x400.png?text=Results+with+Highlights)

### Export/Import
![Export Import](https://via.placeholder.com/800x400.png?text=Export+and+Import+Queries)
